...
{
    public class GitApiUpdateCheck
    {
        ...
        private string GetRequest()
        {
            try
            {
                string url = Properties.Resources.ChechForUpdatesApiUrl;
                HttpWebRequest request = (HttpWebRequest)WebRequest.Create(url);
                request.UserAgent = "MultiBoard update check";
    ...
    public class GithubApiResponds
    {
        public string url { get; set; }
