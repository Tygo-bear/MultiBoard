...
namespace MultiBoard.KeyboardElements
{
    public partial class KeyBoardGUI : UserControl
    {
        ...
        /// </summary>
        public KeyBoardGUI(Keyboard keyboard, List<Script> sList)
        {
            InitializeComponent();
            ScriptList = sList;
            _keyGui = new KeyGui(sList);
        ...
        /// </param>
        /// <param name="exeLoc">
        /// The mTask of the key (open file/press key)
        /// </param>
        /// <returns>
        ...
        private void AddNewKeyClicked(object sender, EventArgs e)
        {
            ...
            _keyGui.settings(keyName, 1, "NONE", true, new MTask(), k);
        ...
        public void LegacyLoadKeys(string mainDirectory)
        {
            ...
            if (_keyboard.KeyboardKeyList.Count > 0)
            {
                ...
                _keyGui.settings(k.key_name, k.EventState, k.keyTag, k.KeyEnabled, k.KeyMTask, k);
                _keyGui.Show();
            }
        ...
        private void userSelectedKey(object sender, EventArgs e)
        {
            ...
            foreach(Key aKey in _keyboard.KeyboardKeyList)
            {
                ...
                {
                    _keyGui.settings(aKey.key_name, aKey.EventState, aKey.keyTag,
                        aKey.KeyEnabled, aKey.KeyMTask, aKey);
                }
            }
        }
